...
├────────────────────────────────────────────────────────────┤
│ [REQUEST_DOC] [LAWYER] [★ Required] [✓ Conditional] │
│                                                             │
...
const template = {
  ...
  steps: [
    ...
    { title: "Request Docs", actionType: "REQUEST_DOC" },
    { title: "Review", actionType: "APPROVAL" },
    { title: "Payment", actionType: "PAYMENT" },
  ]
};
```
